...
- SIEM Correlation & Threat Intelligence Integration
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Splunk-C9C3CF?style=for-the-badge&logo=splunk&logoColor=black" alt="Splunk"/>
  <img src="https://img.shields.io/badge/QRadar-FF6C37?style=for-the-badge&logo=ibm&logoColor=white" alt="QRadar"/>
...
- Developed/maintained IR playbooks/runbooks and detection rule correlations, including role-based access models, for faster resolutions and DPO-compliant decisions under pressure.
- Applied analytical problem-solving to dissect attack vectors in real-time; integrated threat intel (ThreatQ, XSOAR) for holistic log analysis, automated workflows, and DORA compliance.

### System & Network Administrator  
**Expectra then Atos, Olivet (FR)** | *June 2019 – December 2022*  
Managed 24/7/365 production monitoring and optimisation of primarily on-premise Linux infrastructures in a high-risk environment for national critical infrastructure (RTE, a vital operator), ensuring reliability and performance across 4,800+ servers and 92,000+ supervised services.

- Built, managed, and supported complex application stacks: Administration of CentOS, Red Hat, Windows, and Debian; installation, configuration, testing, and maintenance of OS and tools for mission-critical business applications.
- Provided troubleshooting and technical support for Windows/Linux: Rapid on-call assistance to guarantee high availability, minimising disruptions through proactive problem resolution.
- Deployed, configured, and supported VMware: Large-scale virtualisation management with VMware (including ESXi), optimising data centre performance and reliability.
- Ensured compliance and developed SOPs: Strengthened security measures via internal collaboration on documentation and standard operating procedures (SOPs).
...
|---------------|-------------|------|
| [Splunk Expertise](https://www.hs2.fr/formation/formation-splunk/) | Hervé Schauer Sécurité | 2025 |
| [BTL-1](https://www.securityblue.team/certifications/blue-team-level-1) | Security Blue Team | 2025 |
| [TCP/IP Networks](https://openclassrooms.com) | OpenClassrooms | 2020 |
